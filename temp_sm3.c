...
void sm3_compress(uint32_t * s, uint32_t * m)
{
	...
	m0 = rvb_grev(m[0], 0x18);
	m1 = rvb_grev(m[1], 0x18);
	m2 = rvb_grev(m[2], 0x18);
	m3 = rvb_grev(m[3], 0x18);
	m4 = rvb_grev(m[4], 0x18);
	m5 = rvb_grev(m[5], 0x18);
	m6 = rvb_grev(m[6], 0x18);
	m7 = rvb_grev(m[7], 0x18);
	m8 = rvb_grev(m[8], 0x18);
	m9 = rvb_grev(m[9], 0x18);
	ma = rvb_grev(m[10], 0x18);
	mb = rvb_grev(m[11], 0x18);
	mc = rvb_grev(m[12], 0x18);
	md = rvb_grev(m[13], 0x18);
	me = rvb_grev(m[14], 0x18);
	mf = rvb_grev(m[15], 0x18);
