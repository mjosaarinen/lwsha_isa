...
void rv32_keccakp_split(uint32_t v[50])
{
	...
	for (p = v; p != &v[50]; p += 2) {
		...
		t0 = rv32b_unshfl(p[0], 15);
		t1 = rv32b_unshfl(p[1], 15);
...
void rv32_keccakp_join(uint32_t v[50])
{
	...
	for (p = v; p != &v[50]; p += 2) {
		...
		t0 = rv32b_shfl(p[0], 15);
		t1 = rv32b_shfl(p[1], 15);
...
void rv32_keccakp(void *s)
{
	...
	for (q = rc; q != &rc[48]; q += 2) {
		...
		t0 = u0 ^ rv32b_ror(t5, 31);
		t1 = u1 ^ t4;
		t4 = t4 ^ rv32b_ror(t9, 31);
		t5 = t5 ^ t8;
		t8 = t8 ^ rv32b_ror(t3, 31);
		t9 = t9 ^ t2;
		t2 = t2 ^ rv32b_ror(t7, 31);
		t3 = t3 ^ t6;
		t6 = t6 ^ rv32b_ror(u1, 31);
		t7 = t7 ^ u0;
		...
		u0 = v[18] ^ t6;
		u1 = v[19] ^ t7;
		v[12] = rv32b_ror(u0, 22);
		v[13] = rv32b_ror(u1, 22);
		u0 = v[44] ^ t2;
		u1 = v[45] ^ t3;
		v[18] = rv32b_ror(u1, 1);
		v[19] = rv32b_ror(u0, 2);
		u0 = v[28] ^ t6;
		u1 = v[29] ^ t7;
		v[44] = rv32b_ror(u1, 12);
		v[45] = rv32b_ror(u0, 13);
		u0 = v[40] ^ t8;
		u1 = v[41] ^ t9;
		v[28] = rv32b_ror(u0, 23);
		v[29] = rv32b_ror(u1, 23);
		u0 = v[4] ^ t2;
		u1 = v[5] ^ t3;
		v[40] = rv32b_ror(u0, 1);
		v[41] = rv32b_ror(u1, 1);
		...
		u0 = v[26] ^ t4;
		u1 = v[27] ^ t5;
		v[24] = rv32b_ror(u1, 19);
		v[25] = rv32b_ror(u0, 20);
		u0 = v[38] ^ t6;
		u1 = v[39] ^ t7;
		v[26] = rv32b_ror(u0, 28);
		v[27] = rv32b_ror(u1, 28);
		u0 = v[46] ^ t4;
		u1 = v[47] ^ t5;
		v[38] = rv32b_ror(u0, 4);
		v[39] = rv32b_ror(u1, 4);
		u0 = v[30] ^ t8;
		u1 = v[31] ^ t9;
		v[46] = rv32b_ror(u1, 11);
		v[47] = rv32b_ror(u0, 12);
		u0 = v[8] ^ t6;
		u1 = v[9] ^ t7;
		v[30] = rv32b_ror(u1, 18);
		v[31] = rv32b_ror(u0, 19);
		u0 = v[48] ^ t6;
		u1 = v[49] ^ t7;
		v[8] = rv32b_ror(u0, 25);
		v[9] = rv32b_ror(u1, 25);
		u0 = v[42] ^ t0;
		u1 = v[43] ^ t1;
		v[48] = rv32b_ror(u0, 31);
		v[49] = rv32b_ror(u1, 31);
		u0 = v[16] ^ t4;
		u1 = v[17] ^ t5;
		v[42] = rv32b_ror(u1, 4);
		v[43] = rv32b_ror(u0, 5);
		...
		u1 = v[33] ^ t1;
		v[16] = rv32b_ror(u1, 9);
		v[17] = rv32b_ror(u0, 10);
		u0 = v[10] ^ t8;
		u1 = v[11] ^ t9;
		v[32] = rv32b_ror(u0, 14);
		v[33] = rv32b_ror(u1, 14);
		u0 = v[6] ^ t4;
		u1 = v[7] ^ t5;
		v[10] = rv32b_ror(u0, 18);
		v[11] = rv32b_ror(u1, 18);
		u0 = v[36] ^ t4;
		u1 = v[37] ^ t5;
		v[6] = rv32b_ror(u1, 21);
		v[7] = rv32b_ror(u0, 22);
		u0 = v[34] ^ t2;
		u1 = v[35] ^ t3;
		v[36] = rv32b_ror(u1, 24);
		v[37] = rv32b_ror(u0, 25);
		u0 = v[22] ^ t0;
		u1 = v[23] ^ t1;
		v[34] = rv32b_ror(u0, 27);
		v[35] = rv32b_ror(u1, 27);
		u0 = v[14] ^ t2;
		u1 = v[15] ^ t3;
		v[22] = rv32b_ror(u0, 29);
		v[23] = rv32b_ror(u1, 29);
		u0 = v[20] ^ t8;
		u1 = v[21] ^ t9;
		v[14] = rv32b_ror(u1, 30);
		v[15] = rv32b_ror(u0, 31);
		v[20] = rv32b_ror(u3, 31);
		v[21] = u2;
		...
		for (p = v; p <= &v[40]; p += 10) {	//  (5 iterations)
			...
			t0 = rv32b_andn(t8, t6);
			t1 = rv32b_andn(t9, t7);
			t8 = t8 ^ rv32b_andn(t2, u0);
			t9 = t9 ^ rv32b_andn(t3, u1);
			t2 = t2 ^ rv32b_andn(t6, t4);
			t3 = t3 ^ rv32b_andn(t7, t5);
			t6 = t6 ^ rv32b_andn(u0, t8);
			t7 = t7 ^ rv32b_andn(u1, t9);
			u0 = u0 ^ rv32b_andn(t4, t2);
			u1 = u1 ^ rv32b_andn(t5, t3);
			t4 = t4 ^ t0;
			t5 = t5 ^ t1;
			p[0] = u0;
			p[2] = t2;
